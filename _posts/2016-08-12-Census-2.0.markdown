...
It would only need to validate a relatively small JSON packet for completeness and data validity, on failure return sufficient error messages for the client side application to feedback to customers.
